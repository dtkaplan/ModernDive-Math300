...
## Stats 300 proposed changes

Delete histograms and boxplots. Substitute density and violin.

Add choropleths with some colorBrewer stuff about scales.

Add log scales and tables as a good visualization when there are order-of-magnitude differences.

Add a unit on how many digits.

Think about what to do about barplots.
...
## 5NG#3: Histograms DELETE {#histograms}
...
## 5NG#4: Boxplots DELETE {#boxplots}
...
### Boxplots via `geom_boxplot` DELETE {#geomboxplot}
